          ...
          <div className="space-y-8">
            ...
            {display?.demo_credentials && (
              <div className="bg-card-bg p-6 rounded-3xl border border-main/20 shadow-sm">
                ...
                <p className="text-sm text-text opacity-60 mb-4">
                ...
                <div className="space-y-3">
                  {display.demo_credentials.accounts.map((account) => (
                    ...
                    >
                      <span className="text-xs uppercase tracking-widest font-bold text-main block mb-1">
                        {account.role}
                      </span>
                      <span className="text-sm text-text opacity-80 break-all">
                        {account.email}
                      </span>
                    </div>
                  ))}
                </div>
                <p className="text-xs text-text opacity-50 mt-4 border-t border-sideBG/10 pt-3">
                  {currentLang === "ar"
